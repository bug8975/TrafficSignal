...
{
    public partial class DeviceCollectionView : XtraUserControl
    {
        ...
        void InitBindings()
        {
            var fluentAPI = mvvmContext.OfType<TrafficSignal.ViewModels.DeviceCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TrafficSignal.Models.Device,
            ...
            fluentAPI.BindCommand(((DevExpress.Utils.MVVM.ISupportCommandBinding)windowsUIButtonPanel.Buttons[6]), x => x.OpenNetWorkAsync());
            fluentAPI.BindCommand(((DevExpress.Utils.MVVM.ISupportCommandBinding)windowsUIButtonPanel.Buttons[7]), x => x.CloseNetWorkAsync());
            fluentAPI.BindCommand(((DevExpress.Utils.MVVM.ISupportCommandBinding)windowsUIButtonPanel.Buttons[8]), x => x.TestNetWork());
